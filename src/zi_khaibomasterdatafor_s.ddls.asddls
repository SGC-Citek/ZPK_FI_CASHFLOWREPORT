...
define root view entity ZI_KhaiBOMasterDataFor_S
  as select from I_Language
    left outer join I_CstmBizConfignLastChgd on I_CstmBizConfignLastChgd.ViewEntityName = 'ZI_KHAIBOMASTERDATAFOR'
  ...
  composition [0..*] of ZI_KhaiBOMasterDataFor as _KhaiBOMasterDataFor
{
  @UI.facet: [ {
    id: 'ZI_KhaiBOMasterDataFor', 
    purpose: #STANDARD, 
